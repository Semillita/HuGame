...
public class VulkanImageSampler {
	public static VulkanImageSampler create(VulkanGraphics graphics) {
		...
		try (var memoryStack = stackPush()) {
			...
			var samplerCreateInfo = VkSamplerCreateInfo.calloc(memoryStack)
			...
			if (vkCreateSampler(device.getLogical(), samplerCreateInfo, null, samplerHandleBuffer) != VK_SUCCESS) {
