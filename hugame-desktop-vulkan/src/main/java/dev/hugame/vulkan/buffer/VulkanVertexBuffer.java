...
public class VulkanVertexBuffer {
	private static final int VERTEX_BUFFER_USAGE_FLAGS = VK_BUFFER_USAGE_TRANSFER_DST_BIT
	...
	public static VulkanVertexBuffer create(VulkanGraphics graphics, float[] vertices) {
		...
		var buffer = BufferUtils.createWithStagingBuffer(
				graphics,
				bufferSize,
				b -> memcpy(b, vertices),
	...
	public static VulkanVertexBuffer create(VulkanGraphics graphics, int bufferSize) {
		var buffer = BufferUtils.createDynamicBuffer(
				graphics,
				bufferSize,
				VERTEX_BUFFER_USAGE_FLAGS,
				VERTEX_BUFFER_PROPERTIES_FLAGS);
	...
	public VulkanVertexBuffer(VulkanBuffer buffer) {
		this.buffer = buffer;
	}
