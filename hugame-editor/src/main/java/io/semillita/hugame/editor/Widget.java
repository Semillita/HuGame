...
public class Widget implements SplitNode {
  ...
  public Widget(WorkspaceInputManager inputManager) {
    this.tabbedPane =
        new JTabbedPane(JTabbedPane.TOP, JTabbedPane.SCROLL_TAB_LAYOUT) {
          ...
          public String toString() {
            var tabTitles =
                IntStream.range(0, super.getTabCount()).mapToObj(super::getTitleAt).toList();
    ...
    tabbedPane.addComponentListener(
  ...
  public String toString() {
    var tabTitles =
        IntStream.range(0, tabbedPane.getTabCount()).mapToObj(tabbedPane::getTitleAt).toList();
