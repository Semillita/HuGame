...
import io.semillita.hugame.editor.launcher.LauncherWindow;
...
public class Application {
  ...
  public static void main(String... args) {
    ...
    var startupWindow = new LauncherWindow(Application::onProjectOpen);
    startupWindow.repaint();
  }

  private static void onProjectOpen(String path) {
    var editorWindow = new EditorWindow(path, 1600, 800);
  }
